...
import jfSpringBoot.configurations.ExternalizedConfigurations;
import jfSpringBoot.service.ProductService;
...
public class ProductController {
    ...
    //@Qualifier("jsonResourceService") // Permite especificar el servicio a usar
    @Autowired
    @Lazy
